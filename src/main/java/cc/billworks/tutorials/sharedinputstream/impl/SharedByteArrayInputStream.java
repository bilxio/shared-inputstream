package cc.billworks.tutorials.sharedinputstream.impl;

import cc.billworks.tutorials.sharedinputstream.SharedInputStream;
...
public class SharedByteArrayInputStream extends ByteArrayInputStream
     ...
     * byte array.
     *
     * 为整个字节数组创建一个 SharedByteArrayInputStream
     *
     ...
     * bytes.
     *
     * 创建一个从 <code>offset</code> 开始的，长度为<code>length</code>的，
     * 表示部分数组的 SharedByteArrayInputStream
     *
     * @param	buf	the byte array
